...
> 对应 `docs/phase4-requirements.md`。第四阶段定位为“个人化记忆与主动工作流增强”。注意：仓库中已有 `docs/phase4-sidecar-research.md`，那是第一阶段 M4 打包预研的历史文档；本文中的“第四阶段”指第三阶段完成后的产品能力阶段，不替代 sidecar 预研文档。
...
- [x] 梳理 `docs/phase4-sidecar-research.md` 与本阶段文档的命名说明，避免“第四阶段”歧义。
