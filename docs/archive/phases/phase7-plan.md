...
> 对应 `docs/archive/phases/phase7-requirements.md`。第七阶段定位为“可信赖的日常操作层”：在第六阶段已经完成主动个人中枢的基础上，把今日页、搜索、捕获、通知、诊断、Provider、数据体检和端到端 QA 打磨到真实可长期使用的状态。
...
- `docs/archive/phases/phase7-requirements.md`
  - 勾选验收清单。
- `docs/archive/phases/phase7-plan.md`
  - 勾选里程碑任务。
