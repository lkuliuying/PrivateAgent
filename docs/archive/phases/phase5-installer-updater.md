...
>
> - 需求文档：`docs/archive/phases/phase5-requirements.md`
> - 开发计划书：`docs/archive/phases/phase5-plan.md`
...
后续请以 `docs/archive/phases/phase5-requirements.md` 与 `docs/archive/phases/phase5-plan.md` 为准。
