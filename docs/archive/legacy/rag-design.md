...
- `docs/archive/legacy/analysis/rag-data-quality-audit-20260802.ipynb`
- `docs/archive/legacy/analysis/rag-data-quality-report-artifact.json`
- `docs/archive/legacy/analysis/rag-data-quality-validation.md`
...
uv run python scripts/evaluate_rag.py --cases docs/archive/legacy/examples/rag-evaluation-cases.example.json --retrieval versioned
```

真实迁移和独立演练必须先确认目标数据库、隔离 `PA_DATA_DIR` 和报告路径。完整顺序见 `docs/archive/legacy/deployment-guide.md` 和 `docs/archive/legacy/database-upgrade-runbook.md`。
