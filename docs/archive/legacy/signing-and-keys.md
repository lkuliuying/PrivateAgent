...
代码签名接入后，`scripts/build-release.bat` 与 `docs/archive/legacy/release-checklist.md` 需新增：
...
未接入前，`docs/archive/legacy/release-checklist.md` 与 `README.md` 保留 SmartScreen 风险提示与绕过方式。
