...
> 路线更新（2026-08-20）：本计划中的 v0.5 自然日观察和 stable 前置已被 [观察期顺延决策](../observation-policy-20260820.md) 取代；以下内容保留为原始计划与历史验收口径。
...
> 前置验收：[`v0.4.0-alpha.2-checkpoint-20260808.md`](../v0.4.0/v0.4.0-alpha.2-checkpoint-20260808.md)
...
本计划接续并取代 [`integrated-0.5.0-development-plan-20260808.md`](../../archive/planning/integrated-0.5.0-development-plan-20260808.md) 中已经完成的 T0–T3 与过时基线描述；旧文档仍保留为“取消逐版本观察、只保留一次 RC 观察”这一路线决策的历史记录。
