...
> `docs/remaining-work-plan-20260806.md` 接管：M0（a0305cf、「当前状态」统一、`target/` 产物清理）与 M2（1258b8e、真实 Windows 升级与签名负面验证）已完成；
...
- ✓ Phase 8 第 14 项由证据勾选（2026-08-05，`docs/phase8-requirements.md`）。
